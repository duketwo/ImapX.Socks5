...
namespace ImapX.Sample
{
    ...
    public partial class FrmConnect : Form
    {
        ...
        private void Connect(object arg)
        {
            try
            {
                //if (Program.ImapClient.Connect(Program.ImapClient.Host, Program.ImapClient.Port, Program.ImapClient.SslProtocol, false))
                if (Program.ImapClient.Connect(Program.ImapClient.Host, Program.ImapClient.Port, Program.ImapClient.SslProtocol, true, "1.1.1.1", 31337, "asdasdyxcyxc", "asdafasdyxc"))
